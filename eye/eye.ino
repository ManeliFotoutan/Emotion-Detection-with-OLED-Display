...
static const unsigned char PROGMEM image_data_Fortharray[] = { 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
void loop() {
  ...
  while (Serial.available() > 0) {
    ...
    if (incomingEmotion == "happy") {
      ...
      display.display();    // Example action for "angry" emotio
    } 
     else if (incomingEmotion == "surprise") {
      display.clearDisplay();  // Clear the buffer
      display.drawBitmap(0, 0, image_data_Fortharray, 128, 64, 1);
      display.display();    // Example action for "angry" emotio
    }     
    else {
      display.clearDisplay();
      ...
      display.print("show your feeling better");
